...
class _TelaPlanetaState extends State<TelaPlaneta> {
  ...
  Future<void> _insirirPlaneta() async {
    await _controlePlaneta.insirirPlaneta(_planeta);
  }
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Dados do planeta foram ${widget.isIncluir ? 'incluir' : 'alterar'} salvos com sucesso!',
          ),
        ),
      );
